    ...
    <div className="flex min-h-screen items-center justify-center bg-[#0f1117] px-6">
      <div className="w-full max-w-sm space-y-6">
        <div className="text-center space-y-1">
          ...
          <h1 className="text-2xl font-bold text-[#e8eaf0]">Create account</h1>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            <label className="text-sm text-[#8b90a0]" htmlFor="name">
              Full name
            </label>
            <input
              id="name"
        ...
        <p className="text-center text-sm text-[#8b90a0]">
          ...
          <Link href="/login" className="text-[#4f7ef5] hover:underline">
            Sign in
          </Link>
        </p>
      </div>
