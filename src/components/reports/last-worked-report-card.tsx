...
import { readLastWorkedReport, type LastWorkedReportSnapshot } from "@/lib/last-worked-report";

export function LastWorkedReportCard() {
  const [snapshot, setSnapshot] = useState<LastWorkedReportSnapshot | null>(null);

  useEffect(() => {
    setSnapshot(readLastWorkedReport());
  }, []);
